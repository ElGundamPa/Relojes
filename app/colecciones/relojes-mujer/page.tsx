...
export const metadata = {
  title: "Relojes para Mujer | Relojes de Lujo",
  description: "Explora nuestra colección de relojes de lujo para mujer. Elegancia, sofisticación y diseño excepcional.",
};
...
export default async function WomenWatchesPage() {
  ...
  const womenProducts = products.filter(
    (p) =>
      ...
      p.subcategory.toLowerCase().includes("mujer") ||
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-12">
            ...
            <p className="text-xl sm:text-2xl text-muted-foreground max-w-3xl mx-auto mb-8">
              Elegancia y refinamiento en cada pieza. Descubre nuestra exclusiva colección de relojes de lujo para mujer.
            </p>
            <Button size="lg" asChild>
              <Link href="/relojes/todos?gender=mujer">
                Ver todos los relojes para mujer
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">
              {womenProducts.length} {womenProducts.length === 1 ? "reloj disponible" : "relojes disponibles"}
            </p>
          </div>
